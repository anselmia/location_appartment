...
window.addEventListener("DOMContentLoaded", () => {
  ...
  const map = L.map("logement-map").setView([46.5, 2.6], 6); // default view over France
    ...
    if (logement.lat && logement.lng) {
      ...
      <div style="min-width:220px; max-width:260px; font-family:Arial, sans-serif;">
        ...
        <div style="padding:8px 4px 0;">
          ...
          <a href="${
            logement.url
          }" class="btn btn-sm btn-primary" style="background-color:#1d4b8f; color:white; padding:4px 8px; font-size:13px; border-radius:4px; display:inline-block; text-decoration:none;">+ INFO</a>
        </div>
      </div>
    `;
